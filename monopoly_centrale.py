...
class Players:
    # list each properties of each players
    def __init__(player,name, shape, position, money,properties):
        player.name=name
        player.shape = shape
...
playt=Players("john","triangle",0,100,[])

playt.properties.append(case_1)

playt.properties.append(case_3)

playt2=Players("bob","Square",0,2500,[])
